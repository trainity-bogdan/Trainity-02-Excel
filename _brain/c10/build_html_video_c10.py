...
PROMPTS = r'''const PROMPTS = {
  ...
  2: {
    ...
    text: "Vreau să definesc măsura o singură dată, ca sursă unică de adevăr. Spune-mi definiția clară (ce agreg și pe ce bază), cum o ancorez într-un reper sau prag, ce semnal produce față de reper și cum mă asigur că aceeași definiție dă rezultat corect pe orice tăietură. Distinge clar definirea măsurii de compararea ei.",
    meta: "Definiție, bază, reper, semnal. Plus distincția de comparație."
  }
};
