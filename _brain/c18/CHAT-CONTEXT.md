# CHAT-CONTEXT · ANDREI C18 / CLAUDE C18

Acest folder este dedicat exclusiv construcției C18 AUTOMATIZAREA.

## Comanda unică
sync

## Andrei C18 / BRAIN C18
La sync citește doar:
- _brain/c18/CHAT-CONTEXT.md
- _brain/c18/BRAIN-TO-CLAUDE.md
- _brain/c18/CLAUDE-TO-BRAIN.md
...
2. citește _brain/c18/CHAT-CONTEXT.md
3. citește mandatul din _brain/c18/BRAIN-TO-CLAUDE.md
4. execută doar ce este permis în mandat
5. scrie raportul în _brain/c18/CLAUDE-TO-BRAIN.md
6. rulează validările cerute de mandat
7. commit descriptiv pe main + push

## Fișiere permise pentru Claude C18
- _brain/c18/CLAUDE-TO-BRAIN.md
- c18/** doar dacă mandatul BRAIN permite explicit generare / implementare

## Fișiere interzise pentru C18
- toate celelalte cNN/**
- alte _brain/cYY/**
- CLAUDE.md
- README.md
...
## Context conceptual C18
C18 = AUTOMATIZAREA.
T5 = AUTONOMIE.
CUVÂNT LOCKED = MOTOR.
Verb LOCKED = AUTOMATIZEZ.
Axa C18 = DECIZI CE RULEAZĂ FĂRĂ TINE ȘI TE SCOȚI DIN BUCLĂ.
Pilon T5 = T5 consumă raportul livrabil (T4) și îl face să funcționeze fără autor.

## Stare curentă C18
Obiectiv curent: SEED conceptual + SPEC 11-slot C18.
