...
<section class="stage" id="stage-2" data-stage="2" data-stage-ghost="02">
  <header class="stage-header">
    ...
    <div class="stage-meta">
      <div class="stage-label">ETAPA 2 · POZIȚIA ESTE IMPORTANȚĂ</div>
...
<div class="step" data-step="4">
  <div class="step-head" onclick="toggleStep(4)">
    ...
    <h3 class="step-title">Promptul 1: ierarhia și ordinea de citire</h3>
    <div class="step-check" onclick="event.stopPropagation();checkStep(4)" title="Marchează pasul ca verificat"></div>
  </div>
  <div class="step-body">
    <p class="step-action">Lansezi Promptul 1. Pentru obiectele pe care le ai și răspunsul venit din analiză, AI-ul propune ce vede ochiul întâi, ce după și ce se retrogradează. Nu așezi încă; afli o ierarhie de pornire. AI propune ordinea, tu judeci dacă servește decizia.</p>
...
<section class="stage" id="stage-3" data-stage="3" data-stage-ghost="03">
  <header class="stage-header">
    ...
    <div class="stage-meta">
      ...
      <div class="stage-tags"><span class="phase-tag">COMPUNERE</span><span class="type-tag">Focar și flux</span></div>
    </div>
  </header>
  <p class="stage-quote">Stabilești focarul atins primul, apoi traseul: ce vede ochiul după și ce coboară din prim-plan.</p>
  <div class="stage-body">
<div class="step" data-step="5">
  ...
  <div class="step-body">
    <p class="step-action">Alegi focarul: obiectul care poartă răspunsul venit din analiză, și-l plasezi unde cade ochiul primul. <span data-locked="1">O pagină are un singur focar, nu cinci.</span> Nu inventezi importanța aici, o primești din răspuns și o așezi în prim-plan.</p>
...
<div class="step" data-step="6">
  ...
  <div class="step-body">
    <p class="step-action">După focar, ordonezi ce vede ochiul al doilea și al treilea. Construiești fluxul focar, susținere, detaliu, folosind poziția și alinierea ca să ghidezi privirea. Apoi retrogradezi ce nu mută decizia: <span data-locked="1">fără acest element în prim-plan, decidentul hotărăște la fel?</span> Dacă da, coboară din prim-plan, fără să-l ștergi.</p>
