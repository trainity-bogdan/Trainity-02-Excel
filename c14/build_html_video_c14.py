  ...
  },
  {
    ...
    steps: [
      { num: "03", title: "Poziția ca semnal de importanță.",
        ...
        excel: true },
      { num: "04", title: "Focarul vizual.", instr: "", prompt: 1 }
    ]
  },
  {
    id: 3, name: "TRASEUL", emotion: "Ordinea de citire",
    hook: "Ordonăm ce vede ochiul după focar.",
    next: "Și coborâm ce nu mută decizia.",
    steps: [
      { num: "05", title: "Traseul de citire.",
        instr: "După focar, ordonăm ce vede ochiul al doilea și al treilea, construim fluxul focar, susținere, detaliu. <strong>Traseul e drumul pe care îl parcurge decizia.</strong>",
        excel: true },
      { num: "06", title: "Retrogradarea elementelor secundare.",
        instr: "Coborâm din prim-plan ce nu mută decizia, fără să ștergem. <strong>Fără acest element în prim-plan, decidentul hotărăște la fel? Dacă da, coboară.</strong>",
        excel: true }
    ]
  },
  {
  ...
  },
  {
    ...
    steps: [
      { num: "09", title: "Spațiul gol ca instrument de ierarhie.",
        ...
        excel: true },
      { num: "10", title: "Compunerea guvernată de răspunsul venit din T3.", instr: "", prompt: 2 }
    ]
  },
  {
