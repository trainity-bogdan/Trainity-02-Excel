...
<main class="stage" id="stage">
  ...
  <section class="screen" data-screen="executive" data-exec-slide="4" data-frag-total="4">
    ...
    <div class="exec-content"><div class="exec-prelabel frag" data-frag="1">Etapa 4</div><h2 class="exec-title frag" data-frag="2">RELUARE</h2><p class="exec-desc frag" data-frag="3">Pașii ca lanț navigabil, legat de obiecte. Repetitivii, marcați candidat C18, nu automatizați.</p><div class="exec-line frag" data-frag="4"></div></div>
  </section>
  ...
  },
  {
    ...
    steps: [
      ...
      { num: "12", title: "Blocul C: pași, obiect atins, rezultat oglindit.",
        instr: "Fiecare pas, un link la zona lui, cu obiectul OBJ_ și rezultatul oglindit. <strong>Repetitivii, etichetați candidat C18, dar lăsați manuali.</strong>",
        excel: true }
    ]
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      { num: "17", title: "Testul substitutului: altcineva reia, fără tine.",
        ...
        excel: true },
      { num: "18", title: "Granița spre C18: harta e gata, treapta următoare o pune să ruleze.",
        instr: "C17 face munca reluabilă de un om. <strong>Predai pașii candidat C18; automatizarea, guvernarea și predarea încep mai sus.</strong>",
        excel: false }
    ]
  }
];
