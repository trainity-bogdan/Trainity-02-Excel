  ...
  <div class="app-grid">
    ...
    <main class="main-content">
        ...
        <div class="hero-visual">
          ...
          <div class="hero-visual-overlay"><span class="hov-kicker">OBIECTUL CONSTRUCȚIEI · C16</span><span class="hov-object">DECIZIA GATA</span></div>
        </div>
      ...
      <section class="study-intro-top">
        <h1 class="cover-title">Cum să livrezi un raport care produce o decizie</h1>
