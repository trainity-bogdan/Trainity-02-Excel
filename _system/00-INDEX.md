...
| **14** | `14-ARHITECTURA-CONCEPTUALA-T5.md` | **AUTORITATE conceptuală T5** (lanț C17-C20, spina OCAZIE/EFORT/ATENȚIE/PROPRIETATE, cele 6 granițe închise, Testul concediului PASS pe autonomie-rezultat, TEST DE MANIFESTARE EXCEL per construcție; C17 SPEC 11-slot CONFIRMAT, pregătit pentru blueprint). Citește înainte de orice C17-C20. | ~9 KB |
