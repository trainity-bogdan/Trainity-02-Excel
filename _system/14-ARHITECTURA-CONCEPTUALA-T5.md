...
- **C17 SISTEMATIZAREA: SPEC 11-slot CONFIRMAT + ÎNGHEȚAT (ARHITECT, 14 iunie 2026). PREGĂTIT PENTRU SLUG + BLUEPRINT.** Parcurs: seed v2 (anti-SOP) -> SPEC 11-slot -> audit adversarial SPEC (8/10) -> 3 ascuțiri -> freeze. Axă RELUABILITATEA / forma reluabilă; iese din OCAZIE. Artefact `_SISTEM` = **hartă funcțională nativ-Excel** (named ranges SRC_/INPUT_/CONTROL_/PARAM_/OBJ_, hyperlink-uri interne, formule de oglindire), NU SOP; test de manifestare: PASS doar dacă se rupe scos din workbook (#REF!). **Garda OGLINDĂ:** oglindește și navighează, nu execută (C18), nu judecă praguri (C19), nu mută ownership (C20). Sloturi-cheie: HERO „Cum transform munca pe care doar eu o știu într-un sistem pe care altcineva îl pornește?" (MIZA HERO „SISTEMATIZAREA MUNCII RELUABILE"); AHA (lock) „O muncă făcută de două ori nu mai e o livrare. E un sistem ascuns în workbook."; MANTRA „Nu o fac din nou. O fac sistem."; MOTTO C17 „Pleci, și munca o reia altcineva." Cele 11 sloturi + granițe + 8 riscuri + teste = `_brain/c17/CLAUDE-TO-BRAIN.md`. **MOTTO: template de treaptă T5 „Pleci, și munca [...]" = TEMPLATE CANDIDAT (NU LOCKED), se retestează la C18/C19/C20.**
