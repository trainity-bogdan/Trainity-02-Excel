...
readme = [
    ...
    [''],
    ['  T2 CUNOASTERE (C05-C08): profileaza setul descriptiv multidimensional'],
    ['    C05 CLASIFICAREA: dictionarul setului (etichete, frecvente, cardinalitate)'],
    ['    C06 KPI & CALCULE: profil numeric (sume, medii, extreme, distributii)'],
    ['    C07 LOGICA TEMPORALA: profil temporal (interval, ritm, varfuri, goluri)'],
    ['    C08 PREGATIRE ANALIZA: consolidare multi-sursa pentru Data Model T3'],
    [''],
