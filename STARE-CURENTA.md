...
8. **L194 (de rezolvat) — detector cross-contamination over-flaghează handoff legitim:** C03 dă GATE FAIL fals pe „cod C04" = teaserele de predare către C04 (R-TEASER-1/R-HAND-2). De tunat (whitelist handoff) — singura problemă sistemică reală cu ROI mare identificată în audit. Neatins (în afara sarcinii C01/C02).
...
**Stare gate/audit la închidere V58:** C01 GATE PASS (după excepție), C02/C04/C05/C06/C07/C08 PASS, **C03 FAIL (fals pozitiv handoff, L194)**. audit_sync ZERO DRIFT 112/112. index.html actualizat (carduri C01/C02 + cache-bust). Toate pe `main`.
